...
max_int = 100000 # max value of integer in an exp
num_testcases = 100000 # max num of lines in a program
max_exp_length = 30 # max number of elements per expression
percent_ret = 1 # chance of return statement at each line in %
symT = []
...
if input("Generate mode(1) or check TARG mode(2)?: ") == "2":
    ...
    for i in to_read:
        ...
        if x[0] == "PUSH":
            ...
            inp_ct += 1
            mem[x[0][4:-1]] = S.pop()
        print("Processed TARG line " + str(targ_ct) + ", expression line " + str(inp_ct))
